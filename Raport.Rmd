...
|      Spodziewamy się, że w krajach lepiej rozwiniętych długość życia jest większa niż w krajach uboższych. Żeby przekonać się, czy w rzeczywistości tak jest, 

```{r le_developed_developing, fig.cap="\\label{fig:le_developed_developing} Porównanie średniej długości życia dla krajów wysoko i słabo rozwiniętych", fig.align="center", fig.width = 5, fig.height = 3}
...
```{r scattery_le, fig.cap="\\label{fig:scattery_le} Scattery", fig.align="center"}
data[4:22] %>%
