...
\item $\textbf{Infant deaths}$ - oznacza śmiertelność wśród niemowląt/dzieci. Również podana w liczbie śmierci przypadającej na 1000 osób.

\item $\textbf{Alcohol}$ - przeciętna konsumpcja alkoholu u osób powyżej 15 roku życia w ciągu roku. Podana jako liczba czystego alkoholu w litrach.

\item $\textbf{Percentage expenditure}$ - wydatki na zdrowie jako procent PKB per capita.

\item $\textbf{Hepatitis B}$ - odporność na zapalenie wątroby typu B wśród 1-latków podana w procentach.

\item $\textbf{Measles}$ - liczba zanotowanych przypadków Odry na 1000 osób. 

\item $\textbf{BMI}$ - przeciętny indeks BMI całej populacji danego kraju.

\item $\textbf{Under-five deaths}$ - liczba zgonów osób w wieku poniżej 5 lat na milion osób.

\item $\textbf{Polio}$ - odporność na polio wśród 1-latków podana w procentach.

\item $\textbf{Total expenditure}$ - wydatki rządu na zdrowie jako procent wszystkich wydatków.

\item $\textbf{Diphtheria}$ - odporność na błonicę wśród 1-latków podana w procentach.
...
\item $\textbf{Thinness 1-19 years}$ - proporcja osób chudych wśród osób w wieku 10-19 lat. Wyrażona w procentach.

\item $\textbf{Thinness 5-9 years}$ - proporcja osób chudych wśród osób w wieku 5-9 lat. Wyrażona w procentach.

\item $\textbf{Income composition of resources}$ - wskaźnik rozwoju społecznego. Podany jako liczba od 0 do 1.

\item $\textbf{Schooling}$ - czas trwania edukacji podany w latach.
